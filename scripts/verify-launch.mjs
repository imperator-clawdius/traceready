...
const requiredPages = [
  {
    ...
    content: [
      ...
      "/methodology/",
      "/proof/",
      "/proof/public-cocoa-pilot/",
      "/pilot-proof/",
      "/field-notes/eudr-file-errors/",
      "/file-triage/",
      "/order-intake/",
      "/contact/",
      "Jump to checker",
      ...
      "file-room brain and a launch checklist",
      "spreadsheet bouncer",
      "buyer-readable repair boundary",
      "View pilot case",
      "Download evidence pack",
      "/traceready-public-cocoa-pilot-pack.zip",
      "Pilot proof",
      "Request free issue-log triage",
      "Buy 5-file pilot - $745",
      "Scope first, payment second",
      "Do not send raw coordinates until the file is scoped",
      "Send scoped cleanup file",
    ],
  },
  {
    label: "PRIVACY_PAGE",
  ...
  },
  {
    ...
    content: [
      ...
      "Use Stripe only after TraceReady confirms the file is in launch scope",
  ...
  },
  {
    ...
    content: [
      ...
      "one real public cocoa dataset",
      "not a customer case",
      "not a paid transaction",
      "Messy public file in",
      "Exact issue counts out",
  ...
  {
    label: "PUBLIC_COCOA_PILOT_CASE_PAGE",
    path: "/proof/public-cocoa-pilot/",
    content: [
      "Public cocoa pilot case",
      "Messy public file in",
      "57,658 rows with coordinates and area values",
      "Exact issues found",
      "46,134 point-only plots over 4 hectares",
      "Cleaned pack out",
      "Decision: hold for source-owner repair",
      "the cleaned output is a repair brief",
      "not a customer case",
      "Download evidence pack",
      "View checksum manifest",
      "/traceready-public-cocoa-pilot-pack.zip",
  ...
  {
    label: "PUBLIC_COCOA_PILOT_MANIFEST",
    path: "/samples/traceready-public-cocoa-pilot/public-cocoa-pilot-pack-manifest.json",
    content: [
  ...
  {
    label: "FILE_TRIAGE_PAGE",
    path: "/file-triage/",
    content: [
      "Free issue-log triage",
      "Do not send raw farm coordinates first",
      "Paste issue counts, field names, and a non-sensitive sample row shape",
      "24-hour cleanup",
  ...
  {
    label: "PILOT_PROOF_PAGE",
    path: "/pilot-proof/",
    content: [
      "Documented pilot",
      "first anonymized case",
      "Do not include raw coordinates",
      "Publish only with permission",
      "Permission boundary",
      "Can publish only with explicit yes",
      "Case capture packet",
      "Download pilot evidence template",
      "/traceready-documented-pilot-template.txt",
      "Stays private even if the pilot is useful",
  ...
  {
    label: "FIELD_NOTE_EUDR_FILE_ERRORS_PAGE",
    path: "/field-notes/eudr-file-errors/",
    content: [
      "7 EUDR file errors that create buyer-review rework",
      "57,658 public cocoa rows",
      "46,134 point-only plots over 4 hectares",
      "missing plot IDs",
  ...
  },
  {
    ...
    content: [
      ...
      "Do not send raw farm coordinates before scope confirmation",
