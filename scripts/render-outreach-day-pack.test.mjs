...
const BATCH_CSV = `priority,route_id,tier,company_or_channel,segment,why_it_fits,public_route,source_url,proof_url,file_check_url,message_variant,proof_hook,ask,status,next_step
