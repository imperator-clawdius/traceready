...
1,association,European Coffee Federation,EU coffee association,Represents the European coffee sector,public website,https://www.ecf-coffee.org/,association,"Lead with 57,658-row public audit and 46,134 point-only over-4ha plots",Ask for member education route,not_started,Send association variant
...
`);
    ...
    expect(markdown).toContain("https://traceready.online/proof/");
...
`);
    ...
    expect(errors).toContain("packet must include proof page URL");
