...
function renderReplyCaptureNextAction({ challengeSubject, challengeBody }) {
  return [
    ...
    "3. The saved `.eml` must show `founder@traceready.online` in `To`, `Delivered-To`, `X-Original-To`, `Envelope-To`, or another recipient/delivery header.",
    "4. Run `npm run finalize:reply-capture`.",
    "5. Do not submit external forms until reply capture passes and action-time confirmation is explicit.",
    "",
