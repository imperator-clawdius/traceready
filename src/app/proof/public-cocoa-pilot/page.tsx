      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-6 border border-emerald-800 bg-[#123f34] p-6 text-white shadow-sm">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-emerald-50">
            ...
            one-page case study, buyer/supplier follow-up list, reproducibility manifest, and audit
            JSON. It contains derived proof artifacts only, not raw source rows or farm coordinates.
          </p>
